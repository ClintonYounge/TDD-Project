...
**[Test Driven Development]** In this project we will implement a class with some methods, but we will do it by doing test-driven development (TDD).
...
```sh
  ...
  git clone https://github.com/clintonyounge/TDD-Project.git
